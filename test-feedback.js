...
async function runTests() {
  ...
  try {
    const response = await feedbackFunction.handler(validRequestEvent, context);
  ...
  try {
    const response = await feedbackFunction.handler(invalidRequestEvent, context);
    console.log('Status Code:', response.statusCode);
    console.log('Response:', JSON.parse(response.body));
  } catch (error) {
    console.error('Error:', error);
  ...
  try {
    const response = await feedbackFunction.handler(wrongMethodEvent, context);
    console.log('Status Code:', response.statusCode);
    console.log('Response:', JSON.parse(response.body));
  } catch (error) {
    console.error('Error:', error);
