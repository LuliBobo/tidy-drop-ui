...
const Navbar = () => {
  ...
  return <nav className={`fixed top-0 z-50 w-full transition-all duration-300 ${isScrolled || isMenuOpen ? 'bg-white/90 backdrop-blur-md shadow-sm dark:bg-gray-900/90' : 'bg-transparent'}`}>
