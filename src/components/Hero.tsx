...
const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-droptidy-purple-light/20 to-transparent py-20 lg:py-32 flex items-center justify-center">
            ...
            <div className="relative w-full max-w-2xl mx-auto">
              <div className="relative rounded-2xl bg-white p-4 shadow-xl dark:bg-gray-800 animate-float">
                <div 
                  ...
                  onDrop={handleDrop}
                  className={`rounded-xl bg-gray-100 p-8 dark:bg-gray-700 transition-all duration-300 ${
