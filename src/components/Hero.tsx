        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="max-w-2xl">
            ...
            <h1 className="mb-6 text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight">
              ...
              <span className="bg-gradient-to-r from-[#8C52FF] to-[#5E17EB] bg-clip-text text-transparent">
                Clean Your Photos
              </span> in One Click.
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Button className="bg-[#5E17EB] hover:bg-[#5E17EB]/90 text-white" size="lg">
                Get Started Free
              </Button>
              
              <Button 
                variant="outline" 
                className="border-[#5E17EB] text-[#5E17EB] hover:bg-[#5E17EB]/10" 
                size="lg"
